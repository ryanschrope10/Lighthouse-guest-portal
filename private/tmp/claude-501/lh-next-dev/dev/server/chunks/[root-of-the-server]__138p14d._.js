...
"[project]/src/app/api/bookings/[id]/addons/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
      ...
      `
        ...
        const requestRows = requestRowsRaw;
        const requests = requestRows.map((r)=>({
                id: r.id,
                booking_id: r.booking_id,
                guest_id: r.guest_id,
                property_id: r.property_id,
                addon_catalog_id: r.addon_catalog_id,
                ...
                addon_catalog: r.c_id ? {
                    ...
                    price_cents: r.c_price_cents,
                    requires_approval: r.c_requires_approval
                } : null
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: {
...
async function POST(request, { params }) {
    try {
        ...
        if (!body.addon_catalog_id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'addon_catalog_id is required'
            }, {
                status: 400
            });
        }
    ...
    `;
        if (catalogRows.length === 0 || catalogRows[0].property_id !== booking.property_id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'Add-on not available for this property'
            }, {
                status: 404
            });
        }
        ...
        if (!catalog.active) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'Add-on is not currently available'
            }, {
                status: 400
            });
        }
        const priceCents = catalog.price_cents * quantity;
        const status = !catalog.requires_approval && priceCents === 0 ? 'auto_approved' : 'pending';
        const inserted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      ...
      returning *
    `;
        const totalLine = priceCents > 0 ? `Total $${(priceCents / 100).toFixed(2)}.` : '';
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__138p14d._.js.map