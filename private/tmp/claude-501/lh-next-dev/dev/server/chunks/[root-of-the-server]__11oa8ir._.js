...
"[project]/src/lib/newbook/config.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/newbook/client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/newbook/config.ts [app-route] (ecmascript)");
;
...
function createNewBookClient(property) {
    return new NewBookClient((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNewBookCredentials"])(property));
}
}),
"[project]/src/lib/newbook/mappers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/newbook/fixtures.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/newbook/data.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/newbook/client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/newbook/config.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/newbook/mappers.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$fixtures$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/newbook/fixtures.ts [app-route] (ecmascript)");
;
;
;
;
 ...
 */ async function resolveGuestId(explicit) {
    ...
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])();
...
function getProperty() {
    return PROPERTY_PROFILES[(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDefaultProperty"])()] ?? PROPERTY_PROFILES.holiday;
}
...
async function fetchRawBookings(guestId) {
    const key = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDefaultProperty"])()}:${guestId}`;
    const now = Date.now();
    ...
    if (failCache && failCache.key === key && now - failCache.at < FAILURE_TTL_MS) {
        if (offlineFallbackEnabled()) return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$fixtures$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEMO_RAW_BOOKINGS"];
        throw failCache.error;
    }
    try {
        const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createNewBookClient"])();
        ...
        if (offlineFallbackEnabled()) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$fixtures$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEMO_RAW_BOOKINGS"];
        }
        throw error;
    }
}
...
async function fetchRawInvoices(accountIds) {
    ...
    const key = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDefaultProperty"])()}:${[
        ...accountIds
    ].sort().join(',')}`;
    const now = Date.now();
...
async function getBookings(guestId) {
    ...
    const guest_id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["guestPortalId"])(id);
    return raw.map((b)=>{
        const invoices = (byBooking.get(String(b.booking_id)) ?? []).sort((x, y)=>(x.due_on ?? '').localeCompare(y.due_on ?? '')).map((inv)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapNewbookInvoice"])(inv, {
                property_id: property.id,
                guest_id,
                booking_id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bookingPortalId"])(b.booking_id)
            }));
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapBooking"])(b, property, {
            guestId: guest_id,
            invoices
        });
...
async function getDemoGuest(guestId) {
    ...
    const raw = await fetchRawBookings(id);
    for (const b of raw){
        const lead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["primaryGuest"])(b);
        if (lead) {
            return {
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["guestPortalId"])(lead.guest_id),
                ...
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapGuest"])(lead)
            };
        }
    }
    return null;
...
"[project]/src/lib/booking-sync.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "ensureBookingSynced",
    ()=>ensureBookingSynced,
    "resolveNeonBookingId",
    ()=>resolveNeonBookingId
]);
// ============================================================
...
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/newbook/data.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/session.ts [app-route] (ecmascript)");
;
;
;
const nullIfEmpty = (s)=>s && s.length ? s : null;
async function ensureBookingSynced(portalOrNewbookId, guestArg) {
    const guest = guestArg ?? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCurrentGuest"])();
    if (!guest) return null;
    const portalId = portalOrNewbookId.startsWith('nb-bk-') ? portalOrNewbookId : `nb-bk-${portalOrNewbookId}`;
    const b = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$newbook$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBookingById"])(portalId);
    if (!b) return null;
    ...
    const sigStatus = details.signature_status ?? null;
    const sigSignedAt = details.signature_signed_at ?? null;
    const sigDocUrl = details.signature_document_url ?? null;
...
async function resolveNeonBookingId(idOrPortalId, guestArg) {
...
"[project]/src/app/api/bookings/[id]/extend/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/session.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/booking-sync.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(request, { params }) {
    try {
        const guest = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireGuest"])();
        const { id: bookingId } = await params;
        const body = await request.json();
        if (!body.new_check_out) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'new_check_out date is required'
            }, {
                status: 400
            });
        }
        ...
        if (isNaN(newCheckOut.getTime())) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'Invalid new_check_out date'
            }, {
                status: 400
            });
        }
        const booking = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$booking$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureBookingSynced"])(bookingId, guest);
        ...
        if (!booking.check_out) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'Booking has no check-out date to extend'
            }, {
                status: 400
            });
        }
        ...
        if (newCheckOut <= currentCheckOut) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'new_check_out must be after current check-out'
            }, {
                status: 400
            });
        }
        const catalogRows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
    ...
    `;
        if (catalogRows.length === 0 || !catalogRows[0].active) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: null,
                error: 'Stay extension is not offered for this property'
            }, {
                status: 400
            });
        }
        ...
        if (booking.site_or_room) {
            const conflicts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      ...
      `;
        ...
        const extraNights = Math.max(1, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarDays$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["differenceInCalendarDays"])(newCheckOut, currentCheckOut));
        ...
        const status = hasConflict || catalog.requires_approval ? 'pending' : 'auto_approved';
        const details = {
    ...
    `;
      ...
      values (
        ...
        ${hasConflict ? 'Stay extension requested (conflict — may need room move)' : 'Stay extension auto-approved'},
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11oa8ir._.js.map